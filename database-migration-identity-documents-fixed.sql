-- Database Migration: Create Identity Documents Table (Fixed Version)
...
-- SELECT 'identity_documents table created' as status WHERE EXISTS (
--     SELECT 1 FROM information_schema.tables WHERE table_name = 'identity_documents'
-- );

-- SELECT 'View created successfully' as status WHERE EXISTS (
--     SELECT 1 FROM information_schema.views WHERE table_name = 'user_document_verification_status'
-- );

-- SELECT * FROM user_document_verification_status LIMIT 1;
