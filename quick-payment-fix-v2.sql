-- QUICK FIX V2: Create payment system tables (handles existing constraints)
...
-- 4. Add unique constraint (handle if it already exists)
DO $$
BEGIN
    ALTER TABLE user_plan_subscriptions 
    ADD CONSTRAINT unique_user_plan_subscription 
