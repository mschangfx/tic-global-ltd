-- =====================================================
-- SAFE TRANSACTION HISTORY SETUP FOR TIC GLOBAL
-- =====================================================
-- This safely creates/updates tables for transaction history
-- Run this in your Supabase SQL Editor

-- 1. Drop and recreate payment_methods table to ensure correct structure
...
-- 3. Create deposits table if it doesn't exist
...
VALUES ('usdt-trc20', 'USDT', 'TRC20', 'USDT', 'TEHq42c1Kyhe7ShAWYDS61c7aYKNPsT8PF', 10.00, 10000.00, 'Instant - 24 hours');
...
SELECT 'Safe transaction history setup completed successfully!' as result;
